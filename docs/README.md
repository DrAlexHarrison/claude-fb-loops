...
| [request-id-anchor.md](request-id-anchor.md) | the API `request-id` anchor — why it's ungameable, with a live capture ([request-id-live.json](request-id-live.json)) |
...
See also: [`../GAPS.md`](../GAPS.md) (the honest parity ledger) and
